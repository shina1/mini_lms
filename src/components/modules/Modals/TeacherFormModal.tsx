...
const TeacherFormModal = ({ setToggleTeacher, toggleTeacher }: compProps) => {
  return (
    <div className="fixed top-5 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full bg-[rgba(65,70,82,0.7)]">
      ...
      <div className="relative w-full h-full max-w-2xl md:h-auto mx-auto md:top-[50px]">
        <div className="relative bg-white rounded-lg shadow ">
          <button
            onClick={() => setToggleTeacher(!toggleTeacher)}
            type="button"
